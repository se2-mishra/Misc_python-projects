...
class HOSPITAL_MANAGEMENT:
    def __init__(self):
        ...
        self.Message6.configure(text='''OUR HOSPITAL''')
        ...
        self.Button2.configure(text='''1. APPOINTMENTS''')
        self.Button2.configure(width=566)
        self.Button2.configure(command=click_appointment)
        ...
        self.Button3.configure(text='''2. DISPLAY''')
        self.Button3.configure(width=566)
        self.Button3.configure(command=click_display)
        ...
        self.Button4.configure(text='''3. UPDATE''')
        self.Button4.configure(width=566)
        self.Button4.configure(command=click_update)
        ...
        self.Button5.configure(text='''4. BILLING''')
        self.Button5.configure(width=566)
        self.Button5.configure(command=click_billing)
